  ...
  function boot(tz) {
    function applyTzOverrides(tz, G) {
      ...
      if (tz) {
        ...
        function overrideIntlDateTimeFormat() {
        ...
        function overrideDateLocaleString() {
        ...
        function overrideDateConstructor() {
        ...
        overrideIntlDateTimeFormat();
        overrideDateGetters();
        overrideDateSetters();
        overrideDateToString();
        overrideDateLocaleString();
    ...
    function patchWorkers(tz, applyTzOverrides) {
    ...
    function patchIframes(tz, applyTzOverrides) {
    ...
    patchWorkers(tz, applyTzOverrides);
    patchIframes(tz, applyTzOverrides);
  }
})();
